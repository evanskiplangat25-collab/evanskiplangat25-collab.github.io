...
import { K as reactiveOmit, m as _sfc_main$2, E as useAsyncData } from "../server.mjs";
import { M as MDCRenderer } from "./MDCRenderer-D0liT7g8.js";
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    const { data, refresh, error } = ([__temp, __restore] = withAsyncContext(async () => useAsyncData(key.value, async () => {
      ...
      const { parseMarkdown } = await import("./index-XVjGuPOT.js");
...
//# sourceMappingURL=MDC-B7ZZbIm5.js.map
