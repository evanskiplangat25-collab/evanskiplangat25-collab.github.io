...
import { watch as watch2, onMounted } from "vue";
...
var DocumentProjectionNode = createProjectionNode({
  attachResizeListener: (ref9, notify2) => addDomEvent2(ref9, "resize", notify2),
  measureScroll: () => ({
...
import { defineComponent as defineComponent2, getCurrentInstance, watchEffect, toDisplayString } from "vue";
...
import { defineComponent as defineComponent3, onUnmounted, computed as computed2, openBlock, createBlock, resolveDynamicComponent, Transition, TransitionGroup, mergeProps, withCtx, renderSlot as renderSlot2 } from "vue";
...
var _sfc_main3 = defineComponent3({
  ...
  setup(__props) {
    ...
    const transitionProps = computed2(() => {
      if (props.mode !== "wait") {
        return {
          tag: props.as
        };
...
import { defineComponent as defineComponent4, computed as computed3, renderSlot as renderSlot3 } from "vue";
import { isDef as isDef2 } from "@vueuse/core";
var _sfc_main4 = defineComponent4({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return renderSlot3(_ctx.$slots, "default");
    };
  }
});
...
var MotionValueState = class {
  ...
  set(name, value, render, computed7, useDefaultValueType = true) {
    ...
    computed7 && value.addDependent(computed7);
    const remove = () => {
      cancelOnChange();
      render && cancelFrame(render);
      this.values.delete(name);
      computed7 && value.removeDependent(computed7);
    };
...
var addStyleValue = (element, state, key, value) => {
  ...
  if (transformProps.has(key)) {
    ...
    computed7 = state.get("transformOrigin");
  ...
  return state.set(key, value, render, computed7);
};
...
import { defineComponent as defineComponent5, h, Comment, mergeProps as mergeProps2, cloneVNode } from "vue";
...
import { ref as ref2, useAttrs, getCurrentInstance as getCurrentInstance2, onBeforeMount, onMounted as onMounted2, onBeforeUnmount, onUnmounted as onUnmounted2, onBeforeUpdate, onUpdated } from "vue";
function useMotionState(props) {
  ...
  const instance = getCurrentInstance2().proxy;
  onBeforeMount(() => {
    state.beforeMount();
  });
  onMounted2(() => {
...
function handlePrimitiveAndSlot(asTag, allAttrs, slots) {
  ...
  if (asTag === "template") {
    ...
    const mergedProps = firstNonCommentChildren.props ? mergeProps2(allAttrs, firstNonCommentChildren.props) : allAttrs;
...
function createMotionComponent(component, options = {}) {
  ...
  const motionComponent = defineComponent5({
    inheritAttrs: false,
    props: {
...
import { defineComponent as defineComponent6, toRefs, onUpdated as onUpdated2, onBeforeUpdate as onBeforeUpdate2, useAttrs as useAttrs2, openBlock as openBlock2, createBlock as createBlock2, unref as unref2, normalizeProps, guardReactiveProps, withCtx as withCtx2, renderSlot as renderSlot4, createTextVNode, toDisplayString as toDisplayString2 } from "vue";
...
var _sfc_main5 = defineComponent6({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock2(), createBlock2(unref2(Motion), normalizeProps(guardReactiveProps(bindProps())), {
        default: withCtx2(() => [
          renderSlot4(_ctx.$slots, "default"),
          createTextVNode(" " + toDisplayString2(warning3()), 1)
        ]),
        _: 3
      }, 16);
    };
...
import { defineComponent as defineComponent7, toRefs as toRefs2, useAttrs as useAttrs3, computed as computed5, ref as ref3, openBlock as openBlock3, createBlock as createBlock3, unref as unref3, mergeProps as mergeProps3, withCtx as withCtx3, renderSlot as renderSlot5, createTextVNode as createTextVNode2, toDisplayString as toDisplayString3 } from "vue";

// node_modules/motion-v/dist/es/value/use-combine-values.mjs
import { onUnmounted as onUnmounted3 } from "vue";
...
function useComputed(computed7) {
  collectMotionValues.current = [];
  const { value, subscribe, unsubscribe, updateValue } = useCombineMotionValues(computed7);
...
import { isRef, computed as computed4 } from "vue";
function useTransform(input, inputRangeOrTransformer, outputRange, options) {
  if (typeof input === "function") {
    return useComputed(input);
  }
  const transformer = typeof inputRangeOrTransformer === "function" ? inputRangeOrTransformer : isRef(inputRangeOrTransformer) ? computed4(() => transform(inputRangeOrTransformer.value, outputRange, options)) : transform(inputRangeOrTransformer, outputRange, options);
...
var _sfc_main6 = defineComponent7({
  ...
  setup(__props) {
    var _a, _b;
    const props = __props;
    const { style: style3 } = toRefs2(props);
    ...
    const drag = computed5(() => {
      if (props.drag) {
        return props.drag;
      }
      return axis.value;
    });
    const isDragging2 = ref3(false);
    return (_ctx, _cache) => {
      return openBlock3(), createBlock3(unref3(Motion), mergeProps3(bindProps(), {
        drag: drag.value,
        "drag-snap-to-origin": true,
        onDrag: _cache[0] || (_cache[0] = (event, gesturePoint) => {
          const { velocity } = gesturePoint;
          velocity[unref3(axis)] && unref3(updateOrder)(_ctx.value, point2[unref3(axis)].get(), velocity[unref3(axis)]);
        ...
        onLayoutMeasure: _cache[2] || (_cache[2] = (measured) => unref3(registerItem)(_ctx.value, measured))
      }), {
        default: withCtx3(() => [
          renderSlot5(_ctx.$slots, "default", { isDragging: isDragging2.value }),
          createTextVNode2(" " + toDisplayString3(warning3()), 1)
        ]),
        _: 3
      }, 16, ["drag"]);
    };
...
import { defineComponent as defineComponent8, ref as ref4 } from "vue";
var LazyMotion = defineComponent8({
  name: "LazyMotion",
  inheritAttrs: false,
  props: {
    features: {
  ...
  setup(props, { slots }) {
    const features = ref4(Array.isArray(props.features) ? props.features : []);
...
import { onBeforeUpdate as onBeforeUpdate3, onUnmounted as onUnmounted4 } from "vue";
...
import { onUnmounted as onUnmounted5 } from "vue";
...
import { watch as watch3, isRef as isRef2 } from "vue";
function toNumber(v) {
  if (typeof v === "number")
    return v;
  return parseFloat(v);
...
function useSpring(source, config = {}) {
  ...
  const startAnimation = () => {
    ...
    stopAnimation2();
    const springConfig = isRef2(config) ? config.value : config;
...
import { watchEffect as watchEffect3, unref as unref4 } from "vue";
...
function useScroll(scrollOptions = {}) {
  ...
  watchEffect3((onCleanup) => {
    ...
    const cleanup = scroll(
      ...
      {
        offset: unref4(scrollOptions.offset),
        axis: unref4(scrollOptions.axis),
...
import { onMounted as onMounted3, onUnmounted as onUnmounted7 } from "vue";
...
function useReducedMotion(options = {}) {
  ...
  return computed6(() => reducedMotion.value);
}

// node_modules/motion-v/dist/es/utils/use-in-view.mjs
import { ref as ref6, watchEffect as watchEffect4, unref as unref5 } from "vue";
import { unrefElement as unrefElement2 } from "@vueuse/core";
function useInView(domRef, options) {
  const isInView = ref6(false);
  watchEffect4((onCleanup) => {
    const realOptions = unref5(options) || {};
    const { once } = realOptions;
    const el = unrefElement2(domRef);
...
import { ref as ref8, onMounted as onMounted4, onUnmounted as onUnmounted8 } from "vue";
function usePageInView() {
  const isInView = ref8(true);
