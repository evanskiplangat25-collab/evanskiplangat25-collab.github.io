import { L as pausableFilter, u as useAppConfig, M as useMouseInElement, t as tv, N as getSlotChildrenText, l as _sfc_main$2, q as _sfc_main$3, E as useAsyncData, F as queryCollection, c as createError, G as useSeoMeta, H as _sfc_main$4, _ as _sfc_main$6 } from "../server.mjs";
import { _ as _sfc_main$5, a as _sfc_main$7 } from "./PageSection-DdwSi_TV.js";
import { M as Motion } from "./index-MTrLKP1I.js";
import { useSlots, ref, computed, watch, unref, mergeProps, withCtx, createVNode, createBlock, createCommentVNode, openBlock, renderSlot, createTextVNode, toDisplayString, useSSRContext, defineComponent, withAsyncContext, Fragment, renderList } from "vue";
                ...
                links: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    if (unref(page).links) {
                      ...
                      }, unref(page).links[1]), null, _parent3, _scopeId2));
                      _push3(`</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                          ...
                          if (_push4) {
                            _push4(ssrRenderComponent(_component_UPageCard, {
                              ...
                              leading: withCtx((_4, _push5, _parent5, _scopeId4) => {
                                if (_push5) {
                                  _push5(`<span class="text-sm text-muted"${_scopeId4}>${ssrInterpolate(new Date(project.date).getFullYear())}</span>`);
                                } else {
                                  return [
...
//# sourceMappingURL=projects-B_CJ_4eA.js.map
